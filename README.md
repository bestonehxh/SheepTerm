...
[![Download SheepTerm for macOS](https://img.shields.io/badge/Download-SheepTerm_4.1_%281%29_for_macOS-2ea44f?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/bestonehxh/SheepTerm/releases/latest)

**[Get the latest release →](https://github.com/bestonehxh/SheepTerm/releases/latest)** — download `SheepTerm-4.1-1.zip`, unzip, and drag **SheepTerm.app** into `Applications`.
